...
public class TouristNavNotifications extends AppCompatActivity {
    //declare variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tourist_nav_notifications);
    ...
    private void navSelection() {
        ...
        mbtmTNav.setSelectedItemId(R.id.notifications);
