...
public class UserFPWOtp extends AppCompatActivity {
    //declare variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_fpw_otp);
        ...
        mbtnFPWVerify.setOnClickListener(v -> {
            ...
            if(value.isEmpty()){
                Toast.makeText(UserFPWOtp.this, "Invalid OTP Code!", Toast.LENGTH_SHORT).show();
            }
            else {
                verifyCode(value);
            }
    ...
    private final PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(@NonNull FirebaseException e) {
            Toast.makeText(UserFPWOtp.this, "Verification Failed!", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onCodeSent(@NonNull String verID,
            ...
            Toast.makeText(UserFPWOtp.this, "OTP Sent!", Toast.LENGTH_SHORT).show();
        ...
        signInCred.signInWithCredential(credential)
                .addOnCompleteListener(task -> {
                    if(task.isSuccessful()){
                        Intent intent = new Intent(UserFPWOtp.this, UserResetPW.class);
